...
public class ZonePurchaseBehaviour : MonoBehaviour
{
    ...
    [Space] [SerializeField] Text amountText;
    ...
    public void TransformInitialise(Vector3 position, Quaternion rotation, Vector2 size, float canvasSize,
    ...
    {
        amountText.text = CurrenciesFormatter.Format(amount);
    }
