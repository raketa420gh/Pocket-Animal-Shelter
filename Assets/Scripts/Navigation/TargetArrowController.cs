...
public class TargetArrowController : MonoBehaviour
{
    ...
    private List<ArrowCase> activeArrows = new List<ArrowCase>();
    private int activeArrowsCount;
    ...
    /*public ArrowCase RegisterArrow(Transform parent, Vector3 target, Color color, float hideDistance = -1,
        bool autoDisable = false)
    {
        ArrowCase arrowCase = new ArrowCase(parent, arrowPool.GetPooledObject(), color, null, target, hideDistance,
            autoDisable);
    ...
    /*public ArrowCase RegisterArrow(Transform parent, Transform target, Color color, float hideDistance = -1,
        bool autoDisable = false)
    {
        ArrowCase arrowCase = new ArrowCase(parent, arrowPool.GetPooledObject(), color, target, Vector3.zero,
            hideDistance, autoDisable);
    ...
    public class ArrowCase
    {
        ...
        public ArrowCase(Transform parentTransform, GameObject arrowObject, Color color, Transform targetTransform,
            Vector3 targetPosition, float hideDistance = -1, bool autoDisable = false)
        {
            ...
            /*arrowTransform.rotation =
                Quaternion.LookRotation((this.targetPosition - parentTransform.position).SetY(0).normalized,
                    Vector3.up);*/
        ...
        public void LateUpdate()
        {
            ...
            /*arrowTransform.rotation = Quaternion.Lerp(arrowTransform.rotation,
                Quaternion.LookRotation((targetPosition - parentTransform.position).SetY(0).normalized, Vector3.up),
                0.075f);*/
