...
public class DoorBehaviour : MonoBehaviour
{
    ...
    [Space] [SerializeField] float leftDoorAngle = 98;
    [SerializeField] float rightDoorAngle = -98;

    [Space] [SerializeField] float openTime;
    ...
    public void Open()
    {
        ...
        rightDoorTransform.DOLocalRotate(Quaternion.Euler(0, rightDoorAngle, 0), openTime).SetEasing(openEasing)
            .OnComplete(delegate
            {
                isMoving = false;
    ...
    public void Close()
    {
        ...
        rightDoorTransform.DOLocalRotate(Quaternion.Euler(0, 0, 0), closeTime).SetEasing(closeEasing).OnComplete(
            delegate
            {
                isMoving = false;
